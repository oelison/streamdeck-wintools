...
public enum TracingLevel
    ...
    public class Logger
    {
        ...
        private Logger()
        {
            ...
            var logfile = new NLog.Targets.FileTarget("logfile") { FileName = "wintoolsrunner.log", ArchiveEvery=NLog.Targets.FileArchivePeriod.Day, MaxArchiveFiles=3, ArchiveFileName="archive/log.{###}.log", ArchiveNumbering=NLog.Targets.ArchiveNumberingMode.Rolling, Layout = "${longdate}|${level:uppercase=true}|${processname}|${threadid}|${message}" };
