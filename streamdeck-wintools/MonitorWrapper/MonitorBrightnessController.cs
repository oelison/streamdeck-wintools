...
{
    internal class MonitorBrightnessController : IDisposable
    {
        #region DllImport
        ...
        public MonitorBrightnessController()
        {
            UpdateMonitors();
        }
        ...
        private void UpdateMonitors()
        {
            ...
            EnumDisplayMonitors(IntPtr.Zero, IntPtr.Zero, (IntPtr hMonitor, IntPtr hdcMonitor, ref Rect lprcMonitor, IntPtr dwData) =>
            {
                ...
                {
                    Logger.Instance.LogMessage(TracingLevel.WARN, $"{this.GetType()} UpdateMonitors - Cannot get monitor count!");
                    return true;
                }
                ...
                {
                    Logger.Instance.LogMessage(TracingLevel.WARN, $"{this.GetType()} UpdateMonitors - Cannot get physical monitor handle!");
                    return true;
                }
